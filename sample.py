...
def add_arguments(parser):
    ...
    parser.add_argument("--mask_weight", type=bool,
                        default=False, help="True if you want to use masking")
...
if __name__ == '__main__':
    ...
    model2 = VAEG(hparams, placeholders, hparams.nodes,
                  n_f, edges, log_fact_k, hde)
    ...
    i = 0
    while i < 1:
        model2.sample_graph(hparams, placeholders, adj, features, weight,
                            weight_bin, i+hparams.offset, hde, hparams.nodes, hparams.edges)
        i += 1
